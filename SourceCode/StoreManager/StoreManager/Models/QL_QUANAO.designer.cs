...
namespace StoreManager.Models
{
	...
	public partial class SANPHAM : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<CTSANPHAMNHAP> _CTSANPHAMNHAP;
    ...
    partial void OnMALOAIChanged();
		...
		public SANPHAM()
		{
			...
			this._CTSANPHAMNHAP = default(EntityRef<CTSANPHAMNHAP>);
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="SANPHAM_CTSANPHAMNHAP", Storage="_CTSANPHAMNHAP", ThisKey="MASP", OtherKey="MASP", IsUnique=true, IsForeignKey=false)]
		public CTSANPHAMNHAP CTSANPHAMNHAP
		{
			get
			{
				return this._CTSANPHAMNHAP.Entity;
			}
			set
			{
				CTSANPHAMNHAP previousValue = this._CTSANPHAMNHAP.Entity;
				if (((previousValue != value) 
							|| (this._CTSANPHAMNHAP.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._CTSANPHAMNHAP.Entity = null;
						previousValue.SANPHAM = null;
					}
					this._CTSANPHAMNHAP.Entity = value;
					if ((value != null))
					{
						value.SANPHAM = this;
					}
					this.SendPropertyChanged("CTSANPHAMNHAP");
				}
			}
		}
    ...
    partial void OnDONGIAChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="SANPHAM_CTSANPHAMNHAP", Storage="_SANPHAM", ThisKey="MASP", OtherKey="MASP", IsForeignKey=true)]
		public SANPHAM SANPHAM
		{
			get
			{
			...
			set
			{
							...
							|| (this._SANPHAM.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._SANPHAM.Entity = null;
						previousValue.CTSANPHAMNHAP = null;
					}
					this._SANPHAM.Entity = value;
					if ((value != null))
					{
						value.CTSANPHAMNHAP = this;
						this._MASP = value.MASP;
					}
					else
					{
    ...
    partial void OnDTHOAIChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_DTHOAI", DbType="NChar(15)")]
		public string DTHOAI
		{
			get
			{
